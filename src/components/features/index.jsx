            ...
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="grid gap-5 row-gap-5 sm:grid-cols-2">
                    <div className="max-w-md">
                        ...
                        <h6 className="mb-2 font-semibold leading-5 text-indigo-400">Flexible Inventory<br /> Storage</h6>
                    ...
                    <div className="max-w-md">
                        ...
                        <h6 className="mb-2 font-semibold text-indigo-400 leading-5">Omnichannel Inventory <br /> Management</h6>
                        <p className="text-sm text-gray-300">
                    ...
                    <div className="max-w-md">
                        ...
                        <h6 className="mb-2 font-semibold text-indigo-400 leading-5">Optimized Quality Service</h6>
                        <p className="text-sm text-gray-300">

                    ...
                    <div class="container pb-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                        ...
                        <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                            ...
                            <p class="leading-normal text-base md:text-2xl mb-8 text-center md:text-left">
                                Warehousing & Fulfillment requirements call for simplification of process and insights at a glance. Edgistify delivers on both of these promises.
                            </p>
                            ...
                            <div class="grid grid-cols-2 gap-4 text-white">
                                <div class="...">
                                    <h3 class="text-base font-bold"><i class="fa-solid fa-check"></i> Cost Efficient</h3>
                                </div>
                                <div class="...">

                                    <h3 class="text-base font-bold"><i class="fa-solid fa-check"></i> Speedy Fulfillment</h3>
                                </div>
